<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iletisimformu.aspx.cs" Inherits="ArduinoProgramlama.iletisimformu" %>
...
<div class="showcase">
		...
		<div class="showcase-msg">
			<img src="demo/eposta.png" style="float: left; margin: 10px"
				alt="kurumsal" />
			<p>
				<span class="showcase-title">Kurumsal İletişim <span>Formu</span><br /></span>
			</p>
			<br />
		</div>
	</div>
	...
	<div id="breadcrumbs">
		<a title="Home" href="index-2.html" id="breadcrumbs-home"></a> <span
			...
			<a class="pathway" href="#">İletişim</a> <span class="no-link">Kurumsal
				İletişim Formu</span>
		</span>
	</div>
	<!-- end breadcrumb -->
			...
			<div class="layout-cell content-sidebar1">
				...
				<div class="post">
					...
					<div class="componentheading">
						Kurumsal İletişim <strong>Formu</strong>
					</div>
...
<form action="https://sensorium.com.tr/form_mail_kurumsal.php" method="post" id="iletisim_form_tr" >
										<p class="form-subscr-field">
											<label for="adsoyad" id="contact_name_label">Adınız
												Soyadınız: *</label> <input id="adsoyad" type="text"
												name="adsoyad" class="inputbox" size="10" required />
										</p>
										<p class="form-subscr-field">
											<label for="firmaadi" id="contact_name_label">Firmanızın
												Ünvanı:</label> <input id="firmaadi" type="text"
												name="firmaadi" class="inputbox" size="10" />
										</p>
										<p class="form-subscr-field">
											<label for="telefon" id="contact_email_label">Telefonunuz: *</label>
											<input id="telefon" type="text" name="telefon"
												class="inputbox" size="10" required /> <label class="error"
												for="telefon" id="email_error" style="display: none;">Lütfen
												telefon numaranızı giriniz.</label> <label class="error"
												for="telefon" id="invalid_error" style="display: none;">Geçersiz
												bir telefon numarası girdiniz.</label>
										</p>
										<p class="form-subscr-field">
											<label for="eposta" id="contact_email_label">E-Posta
												Adresiniz: *</label> <input id="eposta" type="email"
												name="eposta" class="inputbox" size="10" required /> <label
												class="error" for="eposta" id="email_error"
												style="display: none;">Lütfen e-posta hesabınızı giriniz.</label>
											<label class="error" for="eposta" id="invalid_error"
												style="display: none;">Geçersiz bir e-posta hesabı girdiniz.</label>
										</p>
										<p class="form-subscr-field">
											<label for="konu" id="contact_subject_label">Konu: *</label>
											<input id="konu" type="text" name="konu" class="inputbox"
												size="10" required />
										</p>
										<p class="form-subscr-field">
											<label for="mesaj" id="comment_label">Mesajınız: *</label>
											<textarea id="mesaj" name="mesaj" rows="8" cols="30" required></textarea>
											<label class="error" for="mesaj" id="message_error"
												style="display: none;">Lütfen mesajınızı giriniz.</label>
										</p>
										
										<div class="g-recaptcha" style="float:right;" data-sitekey="6LctWwcaAAAAAMzJEBzTLNMR9RyeXJLLoA0jpIjR"></div>
										...
										<div class="submit-action">
											<p>
												<input type="submit" name="submit"
													class="cool-buttonn csbutton" id="contact_button"
													value="Formu Gönder" />
