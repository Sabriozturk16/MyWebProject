            ...
            <div class="sheet-body">
                <div id="hornav">
                    <ul class="menu">
                        ...
                        <li>
                            <a href="#" id="submenu5"><span>İLETİŞİM</span></a>
                            <div>
                                <ul>
                ...
                <div class="showcase">
                    ...
                    <div class="showcase-msg">
                        ...
                        <p><span class="showcase-title">Genel <span>Özellikleri</span><br /></span></p>
                        <p>Sistem, ethernet üzerinden internet bağlantısı ile veri toplama merkezimize topladığı bilgileri kayıt altına almaktadır.</p>
                        <br />
                    </div>
                </div>	<!-- end. showcase -->
                <!--breadcrumb-->
                <div id="breadcrumbs">
                    ...
                    <span class="breadcrumbs home">
                        ...
                        <span class="no-link">Genel Özellikleri</span>
                    </span>
                </div><!-- end breadcrumb -->
                <!-- main content -->
                    ...
                    <div class="content-layout-row">
                        <div class="layout-cell content-sidebar1">
                            ...
                            <div class="post">
                                ...
                                <div class="componentheading">Genel <strong>Özellikleri</strong></div>
                                ...
                                <div class="post-body">
                                    <div class="post-inner">
                                        <div class="postcontent">
                                            ...
                                            <div class="article">
                                                <p>
                                                    <a href="demo/sistem_sensorium.jpg" target="_blank"><img style="float: right" alt="company" src="demo/sistem_sensorium_tb.jpg" class="pic-border" /></a>
                                                    • Ethernet ile haberleşen, basit komutlar ile set edilebilen, programlanabilen bir üründür.<br />
                                                    • Sistem, ethernet üzerinden internet bağlantısı ile veri toplama merkezimize topladığı bilgileri kayıt altına almaktadır.<br />
                                                    • Sistem, bir bilgisayara ihtiyaç duymadan internet üzerinden çalışmaktadır.<br />
                                                    • SENSORIUM Web arayüzlü yazılımı ile geriye dönük analizler yapılabilir.<br />
                                                    • Uygulama alanında kontrol edilmek istenen sıcaklık ve nem değer aralığı rahatlıkla SET edilebilir.<br />
                                                    • SET değerlerinin dışına çıkılması durumunda, herhangi bir ek donanıma ihtiyaç duymadan 3 farklı şekilde alarm bilgisi alınabilir.<br />
                                                    • Alarm bilgisi, set edilen değerin altındaki ve üstündeki durumlar için ayrı ayrı alınabilir.<br />
                                                    • Alarm bilgisi, tanımlı olan kişilere email ve SMS ile gönderilir.<br />
                                                    • Cihazın, kontrol etmesini istediğiniz minimum ve maksimum sıcaklık değer aralıklarını set edebilirsiniz.<br />
                                                    • Belirlediğiniz set değerlerinin dışına çıkılması durumunda cihazın çıkışlarını kullanarak çeşitli uyarılar verdirebilirsiniz. Bunun için ek bir IO kartına ihtiyaç yoktur.<br />
                                                    • Dolap kapağının kapalı ya da açık olduğu durumları izleyebilirsiniz.<br />
                                                    • Enerji Var ya da Yok bilgisini anlık olarak izleyebilirsiniz.<br />
                                                    • Standart sistemler, bilgisayar gerektirmektedir. Bir bilgisayar minimum 400-500 W/Saat enerji ile çalışmaktadır. Bu durumda, yıllık yaklaşık 595TL enerji sarfiyatı yapmaktadır.<br />
                                                    • SENSORIUM sıcaklık takip sisteminde bilgisayar ihtiyacı yoktur. Sistem, 9W/Saat enerji ile çalışmaktadır. Bu durumda, yıllık sadece yaklaşık 18TL enerji sarfiyatı yapmaktadır.<br />
                                                    • LCD ekran üzerinde sıcaklık set değerleri, dolap sıcaklığı, tarih ve saat bilgisi dönüşümlü olarak izlenebilir.<br />
                                                    • Web tabanlı karekod destekli aşı, serum ve soğuk zincir stok takip sistemi içerir. <br />
                                                </p>
