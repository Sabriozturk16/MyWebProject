<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hakkimizda.aspx.cs" Inherits="ArduinoProgramlama.hakkimizda" %>
...
<img src="demo/features.png" style="float: left; margin: 10px" alt="Features"/>
<p><span class="showcase-title">Hakkımızda<br/></span></p>
<p>2003 yılından bu yana kurumsal yazılım pazarının öncü kuruluşlarından Mert Yazılım, profesyonel ekibinin gücü ile çağdaş ve uluslararası......</p>
<br/>
</div>
</div>	<!-- end. showcase -->
...
<a class="pathway" href="#">Kurumsal</a> 
<span class="no-link">Hakkımızda</span>
</span>
</div><!-- end breadcrumb -->
...
<div class="componentheading"><strong>Hakkımızda</strong></div>
...
<!-- article-content -->
<div class="article">
<p><img style="float: right" alt="company" src="demo/company.jpg" class="pic-border">2003 yılından bu yana kurumsal yazılım pazarının öncü kuruluşlarından Mert Yazılım, profesyonel ekibinin gücü ile çağdaş ve uluslararası kriterlere uygun çözümler geliştirerek koşulsuz müşteri memnuniyetini ilke edinerek hizmet vermektedir. Ürünlerini "trex" ve "sensorium" tescilli markaları altında pazarlamaktadır. </p>
    
<p><strong>Ekibimiz :</strong><br />
• Yazılım Geliştirme<br />
• Elektronik ARGE<br />
• Satış Sonrası Destek<br />
• Eğitim Uyarlama ve Danışmanlık
</p>
<br/>
<p>Kullanıcılarına iş süreçlerinin otomasyonuna yönelik bütünleşik çözümler sunuyor.<br/>
Deneyimi, uygulamaları, sektör bağımsız olarak tüm işletmelerin yapısına kolayca uyarlanabilecek ürünleri ve özellikle satış sonrası destek hizmetiyle öne çıkmaktadır.</p>
<br/>
...
<div class="componentheading"><strong>Misyonumuz</strong></div>
...
<!-- article-content -->
<div class="article">
<p><img style="float: right" alt="company" src="demo/mision.jpg" class="pic-border">
Kurumların bilgi sistemi ihtiyaçlarına kaliteli ve köklü çözümler getirmeyi hedeflemekteyiz. Müşterilerimize sağladığımız sürekli destek ve eğitim hizmeti ile ürünlerimizin daha verimli kullanılmasını hedeflemekteyiz. Güncel ve gelişmiş teknolojik olanakları kullanan yazılım uzmanlarından oluşan kadromuz ile kurumsal bilgi sistemleri geliştirmeye odaklanmaktayız. </p><br/>
</div>
</div>
<div class="cleared"></div>
</div>
...
<div class="componentheading"><strong>İlkelerimiz</strong></div>
...
<!-- article-content -->
<div class="article">
<p><img style="float: right" alt="company" src="demo/ilkelerimiz.jpg" class="pic-border">
Müşterilerimizin koşulsuz mutluluğu bizim için her şeyden önemlidir. Bu nedenle, ürettiğimiz ürün ve hizmetlerin üstün nitelikli olmasına önem verir, toplam kalite yönetimini bir yönetim felsefesi olarak benimseriz.<br/>
Politikaların tespitinde pazarın tercihlerini ve standartlarını gözetmek, müşterilerimiz ile yakın ve sıcak ilişki sürdürmek temel prensibimizdir.</p><br/>
</div>
</div>
<div class="cleared"></div>
</div>
