<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nedenben.aspx.cs" Inherits="ArduinoProgramlama.nedenben" %>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-25809447-1']);
...
<p><span class="showcase-title">Enerji Karlılık Hesabı<br/></span></p>
<p>Sensorium enerji karlılık hesabı ile 3 yıllık aboneliğiniz bedava... Nasıl mı?</p>
<br/>
</div>
</div>	<!-- end. showcase -->
...
<span class="no-link">Enerji Karlılık Hesabı</span>
</span>
</div><!-- end breadcrumb -->
...
<div class="componentheading"><strong>Sensorium Avantajları - Enerji Karlılık Hesabı</strong></div>
...
<!-- article-content -->
<div class="article">
<p><img style="float: right" alt="company" src="demo/kurumsal_kimlik.jpg" class="pic-border">

Bilgisayarlar saatte ortalama 400watt enerji tüketir.<br />
Yani saatte 0.4 kWatt<br />
Günde 24x0.4 = 9.6 kWatt<br />
1 kWatt Elektrik = 0.17 TL<br />
Günlük Elektrik Gideri 0.17x9.6 = 1.632 TL<br />
Aylık Elektrik Gideri 30x1.632 = 48.96 TL<br />
<strong>Yıllık Elektrik Gideri 12x48.96</strong> = <strong>587 TL</strong><br />
